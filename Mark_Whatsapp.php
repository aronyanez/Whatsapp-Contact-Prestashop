...
class Mark_Whatsapp extends Module
{
	...
	public function hookDisplayHeader($params)
	{
		...
		$this->context->controller->registerStylesheet('whatsapp-icon', 'https://use.fontawesome.com/releases/v5.0.13/css/all.css', array('server' => 'remote', 'position' => 'head','media' => 'all', 'priority' => 162));

		$this->context->controller->registerStylesheet('whatsapp-style', 'modules/'.$this->name.'/views/css/style.css',array('media' => 'all', 'priority' => 163));
	}
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submit'.$this->name))
		{
			...
			if ((!$Whats_Number 
				...
				&& (!$Whats_Message || empty($Whats_Message)
